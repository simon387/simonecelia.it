					...
					<div class="row">
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-sm-6 col-md-7">
									<div class="about-info">
										...
										<p><span class="title-s">Email: </span> <span>simone.celia@simonecelia.it</span></p>
							...
							<div class="skill-mf">
								...
								<div class="progress">
									<div class="progress-bar" role="progressbar" style="width: 60%" aria-valuenow="90"
									     aria-valuemin="0"
						...
						<div class="col-md-6">
							<div class="about-me pt-4 pt-md-0">
								...
								<p class="lead">
									Enthusiast Software Engineer, knowledge on various technology solutions, from COBOL to JavaEE, experience on Banking, Insurance, Financing, Energy, Automotive, Food Sector projects and public websites. Design, development, testing and bug fixing from backend to frontend, loving the Open Source Philosophy (GNU/LINUX<3) and the Computer Science Education.
								</p>
								<p class="lead">
									Personal Open Source Projects: <a href="https://github.com/simon387">github.com/simone</a>
								</p>
								<p class="lead">
									Full LinkedIn Profile: <a href="https://www.linkedin.com/in/simone-celia-b5b26a5/">linkedin.com/simone</a>
								</p>
							</div>
						</div>
					</div>
