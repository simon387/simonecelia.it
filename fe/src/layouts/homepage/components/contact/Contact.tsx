...
export const Contact = () => {
	...
	return (
		<section id="contact" className="paralax-mf footer-paralax bg-image sect-mt4 route" style={{backgroundImage: `url(${background})`}}>
			...
			{/*											<div className="form-group">*/}
			{/*												<textarea className="form-control" name="message" id="message" rows="5" placeholder="Message" required*/}
			...
			{/*								<p className="lead"><b>Warning! Any malicious use of telephone numbers will be reported to the authorities and published <a*/}
			{/*									className="blue-a" target="_blank" href="shame.php">here</a>, in the shame list!</b></p>*/}
			{/*								<ul className="list-ico">*/}
			{/*									<li><span className="bi bi-geo-alt"></span> ITALY and SPAIN</li>*/}
			{/*									<li><span className="bi bi-phone"></span> <a href="tel:' . PHONE1 . '">' . PHONE1 . '</a></li>*/}
			{/*									<li><span className="bi bi-phone"></span> <a href="tel:' . PHONE2 . '">' . PHONE2 . '</a></li>*/}
			{/*									<li><span className="bi bi-envelope"></span> <a target="_blank" href="mailto:' . EMAIL . '">' . EMAIL . '</a></li>*/}
			{/*								</ul>*/}
			{/*							</div>*/}
			...
			{/*									</li>*/}
			{/*									<li><a target="_blank" href="' . LINKEDIN . '"><span className="ico-circle"><i className="bi bi-linkedin"></i></span></a></li>*/}
